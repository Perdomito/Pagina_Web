...
export default function Reportes() {
  ...
  const handleImprimir = () => {
    if (misioneroSeleccionado) {
      ...
      doc.text(`${tipoReporte === "semanal" ? t('rp_semanal') : t('rp_mensual')} - ${paisNombre}`, pageWidth / 2, 30, { align: "center" });
      ...
      const datosTabla = [
        ...
        [t('rp_contactosTomaronEstudio'), reporteActual.contactosEstudian.toString()]
      ];
      ...
      const nombreArchivo = `${t('rp_reporte')}_${paisNombre.replace(/\s+/g, '_')}_${periodoTexto.replace(/\s+/g, '_')}.pdf`;
        ...
        {!misioneroSeleccionado && reporteActual && (
          <>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "16px", marginBottom: "24px" }}>
              ...
              <MetricaCard icono={<FaCheckCircle />} titulo={t('rp_contactosTomaronEstudio')} valor={reporteActual.contactosEstudian} anterior={reporteAnterior?.contactosEstudian} color="#8BC34A" />
            </div>
            ...
            <div style={{ background: "#f4f6fb", borderRadius: "12px", padding: "20px", marginTop: "16px", border: "1px solid #e8edf5" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "15px" }}>
                {[
                  ...
                  { label: t('rp_dijeronSi'), value: reporteActual.probabilidadMiembro },
                  { label: t('rp_ovejasPotenciales'), value: reporteActual.ovejasPotenciales }
                ].map((item, idx) => (
