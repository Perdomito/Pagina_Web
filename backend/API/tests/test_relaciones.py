...
RELACIONES_ESPERADAS = {
    ...
    # Detalle 1:1 del seguimiento: si se borra el seguimiento se va con el.
    "entrevistas.seguimiento_id": ("seguimiento_leyes", "CASCADE"),
    "entrevistas.entrevistador_id": ("miembros", "SET NULL"),
    ...
    "examenes_romanos.seguimiento_id": ("seguimiento_leyes", "CASCADE"),
    "examenes_romanos.evaluador_id": ("miembros", "SET NULL"),
    ...
    "miembros.iglesia_id": ("iglesias", "SET NULL"),
    ...
    # RESTRICT en contacto_id: un contacto con seguimiento abierto no se borra.
    "seguimiento_leyes.contacto_id": ("contactos", "RESTRICT"),
    "seguimiento_leyes.pais_id": ("paises", "SET NULL"),
    "seguimiento_leyes.miembro_contacto_id": ("miembros", "SET NULL"),
    "seguimiento_leyes.miembro_estudios_id": ("miembros", "SET NULL"),
    "seguimiento_leyes.miembro_convertido_id": ("miembros", "SET NULL"),
    "seguimiento_leyes_historial.seguimiento_id": ("seguimiento_leyes", "CASCADE"),
